...
classdef youbotDstar < Navigation
    ...
    methods
        ...
        % constructor
        function ds = youbotDstar(world, varargin)
...
%             end
            ...
            occgrid = zeros(size(ds.costmap));
            occgrid(ds.costmap == Inf) = 1;
            ds.occgrid = occgrid;
